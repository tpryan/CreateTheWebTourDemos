...
sym.$("europe_btn").css('cursor','pointer');
...
//  (sym.$("name") resolves an Edge element name to a DOM
//  element that can be used with jQuery)
sym.$("aus_btn").css('cursor','pointer');
...
//  (sym.$("name") resolves an Edge element name to a DOM
//  element that can be used with jQuery)
sym.$("asia_btn").css('cursor','pointer');
...
Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 1871.7830283377, function(sym, e) {
...
Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 4962.7830283377, function(sym, e) {
...
sym.$("closeaf_btn").css('cursor','pointer');
...
Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 8121.7830283377, function(sym, e) {
...
sym.$("closena_btn").css('cursor','pointer');
...
Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 10871.783028338, function(sym, e) {
...
sym.$("closesa_btn").css('cursor','pointer');
...
Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 13871.783028338, function(sym, e) {
...
sym.$("closeoc_btn").css('cursor','pointer');
...
Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 17371.783028338, function(sym, e) {
...
sym.$("closeeu_btn").css('cursor','pointer');
...
(function(symbolName) {
Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 571.62109375, function(sym, e) {
sym.stop();
...
sym.$("source_txt").css('cursor','pointer');
...
sym.$("edge_txt").css('cursor','pointer');
