...
"stage": {
   ...
   timelines: {
      "Default Timeline": {
         ...
         autoPlay: true,
         timeline: [
            { id: "eid10", tween: [ "style", "${_Text3}", "top", '15px', { fromValue: '-71.7px'}], position: 2000, duration: 1000 },
            { id: "eid8", tween: [ "style", "${_buildings}", "top", '134px', { fromValue: '316px'}], position: 0, duration: 1000, easing: "easeOutBounce" },
            { id: "eid2", tween: [ "style", "${_details}", "opacity", '1', { fromValue: '0'}], position: 1000, duration: 1000, easing: "easeInOutElastic" }         ]
      }
   }
}
};
