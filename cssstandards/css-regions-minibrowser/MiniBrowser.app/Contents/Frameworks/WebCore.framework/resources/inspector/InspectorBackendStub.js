...
InspectorBackendStub = function()
{
    ...
    this._registerDelegate('{"id": 0, "domain": "Runtime", "command": "evaluateOn", "arguments": {"objectId": "string","expression": "string"}}');
    this._registerDelegate('{"id": 0, "domain": "Runtime", "command": "getProperties", "arguments": {"objectId": "string","ignoreHasOwnProperty": "boolean","abbreviate": "boolean"}}');
    this._registerDelegate('{"id": 0, "domain": "Runtime", "command": "setPropertyValue", "arguments": {"objectId": "string","propertyName": "string","expression": "string"}}');
    this._registerDelegate('{"id": 0, "domain": "Runtime", "command": "releaseObject", "arguments": {"objectId": "string"}}');
    this._registerDelegate('{"id": 0, "domain": "Runtime", "command": "releaseObjectGroup", "arguments": {"objectGroup": "string"}}');
    this._registerDelegate('{"id": 0, "domain": "Console", "command": "enable", "arguments": {}}');
    this._registerDelegate('{"id": 0, "domain": "Console", "command": "disable", "arguments": {}}');
    ...
    this._registerDelegate('{"id": 0, "domain": "Network", "command": "getCachedResources", "arguments": {}}');
    this._registerDelegate('{"id": 0, "domain": "Network", "command": "getResourceContent", "arguments": {"frameId": "string","url": "string","base64Encode": "boolean"}}');
    ...
    this._registerDelegate('{"id": 0, "domain": "DOM", "command": "pushNodeToFrontend", "arguments": {"objectId": "string"}}');
    this._registerDelegate('{"id": 0, "domain": "DOM", "command": "setSearchingForNode", "arguments": {"enabled": "boolean"}}');
    this._registerDelegate('{"id": 0, "domain": "DOM", "command": "highlightDOMNode", "arguments": {"nodeId": "number"}}');
    this._registerDelegate('{"id": 0, "domain": "DOM", "command": "hideDOMNodeHighlight", "arguments": {}}');
    this._registerDelegate('{"id": 0, "domain": "DOM", "command": "highlightFrame", "arguments": {"frameId": "string"}}');
    this._registerDelegate('{"id": 0, "domain": "DOM", "command": "hideFrameHighlight", "arguments": {}}');
    this._registerDelegate('{"id": 0, "domain": "DOM", "command": "pushNodeByPathToFrontend", "arguments": {"path": "string"}}');
    this._registerDelegate('{"id": 0, "domain": "DOM", "command": "resolveNode", "arguments": {"nodeId": "number"}}');
    ...
    this._registerDelegate('{"id": 0, "domain": "Debugger", "command": "evaluateOnCallFrame", "arguments": {"callFrameId": "string","expression": "string","objectGroup": "string","includeCommandLineAPI": "boolean"}}');
