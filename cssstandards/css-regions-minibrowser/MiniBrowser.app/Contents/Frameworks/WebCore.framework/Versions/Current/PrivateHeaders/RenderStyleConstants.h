...
#if ENABLE(REGIONS)
    enum WrapShapeMode { WrapShapeModeNone, WrapShapeModeLeft, WrapShapeModeRight, WrapShapeModeContent, WrapShapeModeAround, WrapShapeModeMaximum, WrapShapeModeTopBottom };     
#endif
