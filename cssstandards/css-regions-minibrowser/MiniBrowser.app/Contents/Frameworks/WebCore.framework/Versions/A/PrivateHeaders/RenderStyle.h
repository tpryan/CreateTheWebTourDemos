...
public:
...
#if ENABLE(REGIONS)
    const AtomicString& flowThread() const { return rareInheritedData->m_flowThread; }
    ...
    WrapShapeMode wrapShapeMode() const { return static_cast<WrapShapeMode>(rareNonInheritedData->m_wrapShapeMode); }
    int wrapShapeOrder() const { return rareNonInheritedData->m_wrapShapeOrder; }
    PolygonShape* wrapShape() const { return rareNonInheritedData->m_wrapShape.get(); }
    bool renderWrapShape() const { return rareNonInheritedData->m_renderWrapShape; }
    
    Length wrapShapeMargin() const { return rareNonInheritedData->m_wrapShapeMargin; }
    Length wrapShapePadding() const { return rareNonInheritedData->m_wrapShapePadding; }
    
    bool hasWrapShapeMode() const { return rareNonInheritedData->m_wrapShapeMode != WrapShapeModeNone; }
#endif
...
// attribute setter methods
...
#if ENABLE(REGIONS)
    // CSS Regions setters
    void setFlowThread(const AtomicString& n) { SET_VAR(rareInheritedData, m_flowThread, n); }
    ...
    void setWrapShapeMode(WrapShapeMode mode) { SET_VAR(rareNonInheritedData, m_wrapShapeMode, mode); }
    void setWrapShapeOrder(int order) { SET_VAR(rareNonInheritedData, m_wrapShapeOrder, order); }
    void setWrapShape(PassRefPtr<PolygonShape> l) { if (rareNonInheritedData->m_wrapShape != l) rareNonInheritedData.access()->m_wrapShape = l; }
    void setRenderWrapShape(bool b) { if (rareNonInheritedData->m_renderWrapShape != b) rareNonInheritedData.access()->m_renderWrapShape = b; }
    void setWrapShapeMargin(Length l) { SET_VAR(rareNonInheritedData, m_wrapShapeMargin, l); }
    void setWrapShapePadding(Length l) { SET_VAR(rareNonInheritedData, m_wrapShapePadding, l); }
#endif
    ...
    static PolygonShape* initialShape() { return 0; }
    static bool initialRenderWrapShape() { return false; }
    static WrapShapeMode initialWrapShapeMode() { return WrapShapeModeNone; }
    static int initialWrapShapeOrder() { return 0; }
    static Length initialWrapShapeMargin() { return Length(0, Fixed); }
    static Length initialWrapShapePadding() { return Length(0, Fixed); }
#endif
