...
public:
    ...
    bool hasWrapShapeMode() const { return style() && style()->hasWrapShapeMode(); }
#endif
...
#if ENABLE(REGIONS)
    virtual void repaintRegion(const IntRect& r, bool immediate);
#endif
...
#if ENABLE(REGIONS)
    RegionController* regionController() const;
#endif
